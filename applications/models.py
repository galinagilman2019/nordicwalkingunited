...
class Form(models.Model):
    ...
    text_header = models.CharField(max_length=255, default=_("Apply for a spot at Nordic Walk United [City]!"))
    text_description = models.TextField(
        default=_(
            ...
            "djangogirls-how-we-scored-applications'>Nordic Walk United "
            "blog</a>. Good luck!"
        )
    )
    confirmation_mail = models.TextField(
        default=_(
            ...
            "your application.\n\n"
            "You'll receive an email from the team that organizes Nordic Walk United {CITY} soon. "
