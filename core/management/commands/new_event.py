...
def get_basic_info():
    ...
    """
    click.echo("Hello there! Let's create new Nordic Walking United event! So exciting!")
...
def command(short):
    """Creates new Nordic Walking United event"""
    # Basics
    ...
    click.echo(f"SUBJECT: Nordic Walking {event.city} setup")
